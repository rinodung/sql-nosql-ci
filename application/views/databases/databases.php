                ...
                <div id="form">
                  ...
                  <form class="form-inline" method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="record" title="Number of record you want to select" value="<?php echo isset($_POST['record']) ? $_POST['record']: 10000?>" placeholder="Number of record you want to select">
                    </div>
                    <input type="hidden" name="action" value="select">
                    <button type="submit" class="btn btn-default" title="start to execute" data-toggle="collapse" data-target="#waiting-progress">Go</button>
                  </form>
                    ...
                    <div class="tab-content">
                      <div role="tabpanel" class="tab-pane active" id="result-time">
                        ...
                        <div class="progress">
                          ...
                          style ="width: <?php echo 100 * ($result['nosql']['time']/$result['sql']['time']);?>%">
